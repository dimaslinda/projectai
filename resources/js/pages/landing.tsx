...
import { Bot, Code, FileText, Globe, MessageSquare, Shield, Sparkles, Users } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold text-slate-900 dark:text-white">ProjectAI</span>
                        </div>
            ...
            <section ref={heroRef} className="relative py-20 lg:py-32">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="hero-element mx-auto mb-8 max-w-3xl text-xl text-slate-600 dark:text-slate-300">
                            Tingkatkan produktivitas dengan AI multi-persona yang disesuaikan untuk engineering, document drafting, ESR, dan berbagai
                            kebutuhan profesional lainnya.
                        </p>
                ...
                <div className="absolute top-20 left-10 opacity-20">
                    <Bot className="floating-icon h-16 w-16 text-blue-500" />
                </div>
