...
import changelog from '@/routes/admin/changelog';
...
export default function Create() {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Changelog', href: changelog.index().url },
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create Changelog Entry</h1>
                        <p className="text-muted-foreground">Add a new version release entry to the changelog</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-6">
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="mt-2 text-sm text-muted-foreground">If unchecked, this entry will be saved as a draft</p>
                                </CardContent>
                            </Card>
